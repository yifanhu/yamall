 ...
 * @version 1.0
 */
public class VWParser2 implements InstanceParser {

    private int constIndex = 0;
    private int bits;
    private int mask_hash;
    private HashMap<Integer, String> invertHashMap = null;
    private HashMap<String, Boolean> ignoreNamespaceHashMap = null;
    ...
    public VWParser2(
        ...
        if (ignoreNamespaces != null) {
            ignoreNamespaceHashMap = new HashMap<String, Boolean>();
            for (String ch : ignoreNamespaces.split(",", -1)) {
    ...
    private void parseSuffix(Instance instance, String subLine) {
        ...
        if (subLine.charAt(0) != ' ') {
            ...
            if (ignoreNamespaceHashMap != null) {
                if (ignoreNamespaceHashMap.containsKey(namespaceName))
                    return;
            }
        }
